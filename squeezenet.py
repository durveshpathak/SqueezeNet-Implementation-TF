...
# -*- coding: utf-8 -*-
"""
Created on Thu May 17 14:33:10 2018
...
# -*- coding: utf-8 -*-
"""
Created on Wed May 16 18:48:44 2018
...
def squeeze_netv_1_1(input, classes):
    """
    ...
    weights = {'conv1': tf.Variable(tf.contrib.layers.xavier_initializer()([3, 3, 3, 64])),
               'conv10': tf.Variable(tf.contrib.layers.xavier_initializer()([1, 1, 512, num_classes]))}
    ...
    output = fire_module(output, s1=16, e1=64, e3=64, channel=64, fire_id='fire2')
    ...
    output = tf.nn.max_pool(output, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding='SAME', name='maxpool5')
...
def optimize(num_iterations):
    ...
    for i in range(total_iterations,
       ...
       # x_batch, y_true_batch = data.train.next_batch(train_batch_size)
        ...
        if i% 10000 == 0:
            save_path = saver.save(session, "Model/Squeeze_net1v1.ckpt")
...
#optimizer = tf.train.GradientDescentOptimizer(learning_rate=4e-2).minimize(cost)
